...
{
    public partial class _25thSIGBNGlobalNav : UserControl
    {
                ...
                SPSecurity.RunWithElevatedPrivileges(delegate ()
                {
                    using (SPSite thisSite = new SPSite(SPContext.Current.Site.WebApplication.AlternateUrls[0].Uri.AbsoluteUri))
                    {
                        ...
                        try
                        {
                            ...
                            {
                                Group navGroup = termStore.Groups["25thSIGBN"];
                        ...
                        {
                            _25thSIGBNNavContainer.Text = "";
                            _25thSIGBNNavContainer.Text = html;
                        }
                    }
                });
            }
